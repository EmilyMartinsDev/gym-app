  ...
  return (
    <Box maxWidth="400px" margin="0 auto" paddingTop="40px">
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl mb="4">
            ...
            {formik.touched.nome && formik.errors.nome ? (
              <Text color="red.500" fontSize="sm" fontWeight={'bold'}>{formik.errors.nome}</Text>
            ) : null}
          </FormControl>
      ...
      <Text textAlign="center" mt="4" fontSize="sm">
        Já tem uma conta? <Text as="b" color="primary.500"><Link to={'/signIn'}>Faça login</Link></Text>
      </Text>
    </Box>
  );
    }
